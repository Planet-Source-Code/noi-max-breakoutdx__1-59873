...
Public Const BLOCK_WIDTH As Long = 64    'Individual block width in pixels
Public Const BLOCK_HEIGHT As Long = 16   'Individual block height in pixels
Private Const BLOCKS_WIDE As Long = 7    'Number of columns to start game with
Private Const BLOCKS_HIGH As Long = 2    'Number of rows to start game with
...
Public Const BALLSPEED As Single = -0.4  'Initial ball speed
Public Const FIREVEL As Single = -0.2
Public Const INCREASE As Single = 0.01   'Speed increase for ball
Public Const MAXSPEED As Single = 0.8    'Maximum ball speed  (if set too high can mess up collisions)
Public Const BLANK_TIME As Long = 2000   'Time to blit blank screen
Public Const TITLE_TIME As Long = 5000   'Time to blit title

'Skip title for dev mode
Private Const TITLE_SKIP As Boolean = False
Private Const BALL_LOSE As Boolean = True
...
Private Sub GameLoop()
   ...
   BallStick = True       'Stick the ball to the paddle
